...
{
    public class RiskControl02 : ReportData
    {
...
and Wraming_1_Ind = 'Y'
and New_Ind = 'Y'
AND Product_Group_2 is not null
...
CASE WHEN D67.Product_Group_1 = '金融債&可贖回零息金融債'
     THEN 1
...
AND D67.Product_Group_2 is not null
UNION ALL
select
NULL,
NULL,
